    ...
    return (
        <Wrapper>
            ...
            <InputContainer>
                ...
                <InputBoxes>
                    <Input name='pickup' value={pickUpLocation} placeholder='Enter pickup location' onChange={(e) => setPickUpLocation(e.target.value)} />
                    <Input name='dropOff' value={dropOffLocation} placeholder='Where to?' onChange={(e) => setDropOffLocation(e.target.value)} />
                </InputBoxes>
